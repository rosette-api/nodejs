 ...
 */
matchedName.prototype.getResults = function(parameters, userKey, serviceURL, callback) {
    ...
    if (parameters.loadParams().name1 == null || parameters.loadParams().name2 == null) {
        throw new RosetteException("badArgument", "Must supply both name1 and name2 parameters to be matched.");
    } else {
        // configure URL
        var urlParts = URL.parse(serviceURL + "matched-name");
        var protocol = https;
