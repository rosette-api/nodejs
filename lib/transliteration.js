...
transliteration.prototype.getResults = function(parameters, userKey, protocol, serviceURL, callback) {
    ...
    if (parameters.documentFile != null) {
        ...
        // validate parameters
        if (parameters.loadParams().content == null) {
            return callback(new RosetteException("badArgument", "Must supply Content", "bad arguments"));
        }
            if (parameters.loadParams().targetLanguage == null) {
            return callback(new RosetteException("badArgument", "Must supply targetLanguage", "bad arguments"));
        }
        if (parameters.loadParams().targetScript == null) {
            return callback(new RosetteException("badArgument", "Must supply targetScript", "bad arguments"));
        }
        if (parameters.loadParams().sourceLanguage == null) {
            return callback(new RosetteException("badArgument", "Must supply sourceLanguage", "bad arguments"));
        }
        if (parameters.loadParams().sourceScript == null) {
            return callback(new RosetteException("badArgument", "Must supply sourceScript", "bad arguments"));
        }
