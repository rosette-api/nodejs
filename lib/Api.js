...
Api.prototype.rosette = function(endpoint, callback) {
    ...
    c.check(api.parameters, this.userKey, this.serviceURL, function(err, res) {
        if (err) {
            ...
            return callback(new RosetteException("incompatibleVersion", "The server version is not compatible with binding version " + rosetteConstants.bindingVersion, res.Version));
        } else {
